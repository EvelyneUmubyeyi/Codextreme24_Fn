  ...
  return (
    <div class="flex h-full items-center">
      ...
      <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:ps-72">
        ...
        <div class="flex justify-center gap-4 py-4 p-14">
          <div>
            <div class="container mx-auto pb-4">
              <div class="w-72 bg-white max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cursor-pointer">
                <div class="h-12 bg-red-400 flex items-center justify-between">
                  <p class="mr-0 text-white text-lg pl-5">Uploaded Projects</p>
                </div>
                <div class="flex justify-between px-5 pt-6 mb-2 text-sm text-gray-600">
                  <p>TOTAL</p>
                </div>
                <p class="py-4 text-3xl ml-5">6</p>
              </div>
            </div>
            <div class="container mx-auto ">
              <div class="w-72 bg-white max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cursor-pointer">
                <div class="h-12 bg-blue-500 flex items-center justify-between">
                  <p class="mr-0 text-white text-lg pl-5">Sold Projects</p>
                </div>
                <div class="flex justify-between px-5 pt-6 mb-2 text-sm text-gray-600">
                  <p>TOTAL</p>
                </div>
                <p class="py-4 text-3xl ml-5">2</p>
              </div>
            </div>
          </div>
          <div>
            <div class="container mx-auto pb-4">
              <div class="w-72 bg-white max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cursor-pointer">
                <div class="h-12 bg-purple-400 flex items-center justify-between">
                  <p class="mr-0 text-white text-lg pl-5">Views</p>
                </div>
                <div class="flex justify-between pt-6 px-5 mb-2 text-sm text-gray-600">
                  <p>TOTAL</p>
                </div>
                <p class="py-4 text-3xl ml-5">60</p>
              </div>
            </div>
            <div class="container mx-auto">
              <div class="w-72 bg-white max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cursor-pointer">
                ...
                <p class="py-4 text-3xl ml-5">12</p>
              </div>
            </div>
          </div>
        </div>
