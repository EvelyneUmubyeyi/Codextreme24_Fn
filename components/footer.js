...
export default function Footer() {
  return (
    <>
      <footer class="w-full max-w-[85rem] py-2 px-4 sm:px-6 lg:px-8 mx-auto border-t border-gray-200">
        <div class="text-center">
          ...
          <div class="mt-3">
            <p class="text-gray-500">
              ...
              in the CodeXtreme Hackathon.
            </p>
            <p class="text-gray-500">
              © Sway 2024. <br></br>All rights reserved.
            </p>
          </div>
